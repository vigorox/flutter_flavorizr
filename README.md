...
| android:adaptiveIcons   | Android       | Creates a set of adaptive icons for each flavor according to the iconForeground and iconBackground directives  |
...
| iconForeground      | String |         | false    | The adaptive icon (foreground) path for this android flavor                |
| iconBackground      | String |         | false    | The adaptive icon (background) path for this android flavor                |
